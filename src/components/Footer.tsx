        ...
        <div className="grid md:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            {[
              ...
              <Link key={l.label} href={l.href} className="block text-zinc-500 text-sm mb-2.5 hover:text-zinc-900 transition-colors duration-200">
                {l.label}
              </Link>
            ))}
          </div>
          <div>
            <h4 className="text-xs text-zinc-400 uppercase tracking-wider mb-4">Продукция</h4>
          ...
          <div>
            ...
            <a href="tel:+79885807630" className="block text-zinc-500 text-sm mb-2.5 hover:text-zinc-900 transition-colors duration-200">
              +7 (988) 580-76-30
            </a>

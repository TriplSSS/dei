    ...
    <>
        ...
        <div className="max-w-[1400px] mx-auto">
          <Reveal direction="left">
            <h1 className="text-4xl md:text-5xl lg:text-[3.5rem] font-bold tracking-tighter leading-[1.06] mb-6 text-white">
              О компании<br />
              <span className="text-red-500">ДонЭлектроИнтел</span>
            </h1>
          </Reveal>
          <Reveal direction="left" delay={0.1}>
            <p className="text-zinc-400 text-lg leading-relaxed max-w-[600px]">
      ...
      <section className="py-20 px-6">
        <div className="max-w-[1400px] mx-auto grid lg:grid-cols-2 gap-16 items-start">
          <Reveal>
            <h2 className="text-3xl md:text-4xl font-bold tracking-tighter mb-6 text-white">Наш подход</h2>
            <p className="text-zinc-400 leading-relaxed mb-6 max-w-[520px]">
          ...
          <Reveal delay={0.1}>
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={i} className="py-6 px-5 border border-zinc-800/50 rounded-xl text-center bg-zinc-900/30 hover-lift">
          ...
          <div className="space-y-0">
            {timeline.map((t, i) => (
              <Reveal key={i} delay={i * 0.06} direction={i % 2 === 0 ? "left" : "right"}>
                <div className="flex gap-6 py-7 border-b border-zinc-800/50 last:border-b-0 group">
                  <span className="text-3xl md:text-4xl font-bold text-red-600/20 group-hover:text-red-600/40 transition-colors duration-500 tabular-nums shrink-0 w-[100px]">
                    {t.year}
                  </span>
